...
const alloweOrigin = {
  "http://127.0.0.3:3000": true,
  "http://127.0.0.3:4000": true,
};
...
const originAppName = {
  "http://127.0.0.3:3000": "sso_consumer",
  "http://127.0.0.3:4000": "simple_sso_consumer",
};
...
const storeApplicationInCache = (origin, id, intrmToken) => {
  ...
  // console.log("seesionApp", sessionApp);
...
const doLogin = (req, res, next) => {
  ...
  console.log("running doLogin", req.session.user);
